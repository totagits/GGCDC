...
{id:'workforce',name:'Community workforce registry',short:'Workforce',description:'Consent-based profiles for matching residents to verified opportunities.',fields:[f('occupation','Primary trade / occupation'),f('skills','Skills and certifications','textarea'),f('experience','Years of experience','number'),f('availability','Availability','select',['Available now','Within 30 days','Not currently available']),f('contact','Contact number'),f('qualification','Qualification / license'),f('consent','Consent to share profile with prospective employers','select',['Yes','No']),f('consentDate','Consent date','date')]},
