...
{id:'suppliers',name:'Grand Gedean enterprise & supplier directory',short:'Suppliers',description:'Verify Grand Gedean beneficial ownership, capacity, and prequalify local contractors for concession procurement.',fields:[f('ownership','Grand Gedean Ownership Share','select',['100% Grand Gedean Owned','75% - 99% Grand Gedean Owned','Grand Gedean Owned (Statutory Preference)','Joint Venture (County Partner)','Non-County Majority (Ineligible for Local Quota)']),f('sector','Primary Commercial Sector','select',['Civil Construction (Offices, Canteens, Schools, Clinics)','Catering, Canteen & Food Service','Fresh Agricultural Produce & Food Supplies','Haulage, Earthmoving & Aggregate Transport','Metal Fabrication, Welding & Maintenance','Industrial Solar, Electrical & HVAC','Camp Janitorial, Laundry & Waste Services','Physical Site Security & Asset Guarding','Agro-Processing, Local Timber & Furniture','Surveying, Environmental & Professional Services']),f('principals','Grand Gedean Shareholders / Founders & Clans'),f('registration','Liberia Business Registry (LBR) & TIN #'),f('taxStatus','LRA Tax Clearance Status','select',['Current & Cleared (Bid Ready)','Tax Clearance Pending LRA Audit','Assistance Needed for Formalization']),f('headquarters','Grand Gedeh Yard / Office Location','select',['Zwedru Commercial District','Putu Mining Corridor','Pennoken Industrial Hub','Gbarzon District','Konobo / Cavalla Basin','Monrovia Liaison Branch']),f('capacity','Machinery, Fleet & Daily Capacity','textarea'),f('employees','Number of Permanent Staff (% Grand Gedeans)'),f('pastContracts','Past Projects & References','textarea'),f('contact','Official Business Contact (Phone / WhatsApp / Email)'),f('endorsement','County Chamber / Elder Endorsement'),f('prequalificationStatus','GGCDC Prequalification Status','select',['Prequalified Local Contractor','Endorsed for Concession Direct Award','Approved for Concession Tender Shortlist','Capacity Building & Formalization Required']),f('proofDocument','Uploaded Ownership Ledger & LBR Proof')]},
...
export const consultativeRoadmap: RoadmapPhase[] = [
  ...
  },
  {
    ...
    keyMilestones: [
      ...
      'Establishment of the Stakeholder Delegate Allocation Formula',
  ...
  },
  {
    ...
    status: 'Upcoming',
    timeline: 'Q4 2026',
    description: 'Historic formal assembly convened in Zwedru with accredited delegates across all stakeholder pillars to constitutionally adopt the Charter, swear in the Executive Secretariat, and formally inaugurate GGCDC.',
    keyMilestones: [
