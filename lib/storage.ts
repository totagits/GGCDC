...
export const initialRecords: RecordItem[] = [
  ...
  // 6. SUPPLIERS
  {
    ...
    due_date: '2026-11-30',
    summary: 'Consortium of 14 local truck owners operating 26 heavy tipper trucks and 4 low-bed trailers. Fully tax-registered and prequalified.',
    details: JSON.stringify({
      sector: 'Heavy Transportation & Earthmoving Logistics',
      registration: 'Liberia Business Registry #2024-TR-0912 / Tax Clearance Current',
      ...
      contact: 'Marcus K. Gaye (+231-776-554-321)',
      readiness: 'Bid ready',
      support: 'Access to affordable trade credit facility for bulk tire purchasing and automated fleet GPS tracking software.'
    }),
    created_by: 'business-chamber@ggcdc.org.lr',
  ...
  },
  {
    ...
    due_date: '2026-10-15',
    summary: 'Grassroots cooperative of 85 smallholder farmers producing eggs, dressed chicken, cabbage, cassava, and plantains.',
    details: JSON.stringify({
      sector: 'Agriculture, Livestock & Food Processing',
      registration: 'Cooperative Development Authority (CDA) Reg #CDA-GG-118',
      ...
      contact: 'Hawa V. Kromah (+231-886-778-990)',
      readiness: 'Needs support',
      support: 'Solar-powered cold room installation, sanitary food-handling HACCP certification, and commercial delivery refrigeration van.'
    }),
    created_by: 'women-rep@ggcdc.org.lr',
